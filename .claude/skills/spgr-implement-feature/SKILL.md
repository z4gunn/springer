...
7. Run the full suite again with spgr-run-tests, then run the linter and formatter. The story is not ready until all acceptance tests pass, all unit tests pass, the linter passes, the formatter passes, and no new lint errors were introduced.
