...
9. Lint and format the scaffold clean before handing off. Keep the work to one logical change per commit. Record any consequential choice (ESP client options, queue binding, guard mechanism) with spgr-log-decision.
