...
- The notation policy and the Mermaid limitation list are in /Users/gunderer/Repos/springer/.claude/references/tool-selection.md. Do not restate them here.
