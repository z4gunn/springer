...
<!--
GOLDEN TEMPLATE — copy to <repo>/skills/spgr-<verb-noun>/SKILL.md and fill in. Delete every comment before shipping.
RULES (see ../BUILD-STANDARDS.md): frontmatter is EXACTLY name + description; body imperative & <500 lines;
all "when to use" lives in description, never here; push detail to references/; no README/CHANGELOG.
SOURCE: vault/40-projects/springer/skills/spgr-skill-<name>.md  → use its "Phase 2 Build Notes" as the build brief.
-->
